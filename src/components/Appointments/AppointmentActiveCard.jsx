...
export default function AppointmentActiveCard() {
  return (
    <>
      <div className="appointment-card">
        ...
        <h4 className="appointment-doctor-title">Billy Long</h4>
        <p className="appointment-doctor-p">General Practitioners</p>
        ...
        <div className="divider">
          <svg
            ...
            fill="none"
          >
            <path d="M0 1H349" stroke="#002FA1" />
          </svg>
        </div>
        <div className="">
          <p className="active-inactive">Ongoing</p>
          <p className="appointment-time">Thu, Jan 11 at 09.00 AM - 11.30 AM</p>
        </div>
      </div>
    </>
  );
