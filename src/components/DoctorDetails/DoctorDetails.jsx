    ...
    return (
        <div className="doctor-details-container">
            ...
            <div className="doc-profile">
                ...
                <div className="doc-info-container">
                    <div className="doc-name-profession">
                        ...
                        <span className="doc-profession">Doctor profession</span>
                    </div>
                    <div className="doc-rating-experience">
                        ...
                        {RATING_ICON}
                            <div className="rating-info">
                                <span>Rating</span>
                                <span className="rate">5.0 <span className="num-of-ratings">(5410)</span></span>
                            </div>
                        </div>
            ...
            <div className="doc-about">
                ...
                <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Fuga odio eos accusamus vero culpa cupiditate totam magni, quia laboriosam iusto.</p>
            </div>
        </div>
    );
}
